 ...
 * Blog2 data helper
 */
namespace Medvslav\Blog2\Helper;
...
{
    /**
     * Path to store config where count of blog2 posts per page is stored
     *
     * @var string
     */
    const XML_PATH_ITEMS_PER_PAGE     = 'blog2/view/items_per_page';
    ...
    /**
     * Remove Blog2 item image by image filename
     *
     ...
     * @return bool|string
     */
    public function resize(\Medvslav\Blog2\Model\Blog2 $item, $width, $height = null)
    {
        if (!$item->getImage()) {
            return false;
        }
    ...
    /**
     * Return the base media directory for Blog2 Item images
     *
     * @return string
     */
    ...
    /**
     * Return the Base URL for Blog2 Item images
     *
     * @return string
     */
     ...
     * @return int
     */
    public function getBlog2PerPage()
    {
